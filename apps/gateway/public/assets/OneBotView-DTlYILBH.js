import{T as te}from"./Tag-CO0XoaGp.js";import{D as re,E as O,G as B,H as t,J as le,K as W,L as K,N as ne,O as ae,d as J,P as ee,Q as se,i as y,c as x,R as w,S as M,T as f,b as C,U as ie,V as de,W as ce,m as G,X as H,u as pe,n as be,o as ue,e as p,f as P,g as b,r as I,h as X,t as N,F as ge,Y,j as z,I as U,B as q,_ as ve}from"./index-CVSYZicp.js";import{g as he,S as me}from"./Space-saj6_gLX.js";import{u as fe}from"./use-compitable-B4Qt2vPD.js";import{S as ye}from"./Spin-DN_9YFsc.js";import{S as xe}from"./Switch-VZipDA4q.js";var Se={thPaddingBorderedSmall:"8px 12px",thPaddingBorderedMedium:"12px 16px",thPaddingBorderedLarge:"16px 24px",thPaddingSmall:"0",thPaddingMedium:"0",thPaddingLarge:"0",tdPaddingBorderedSmall:"8px 12px",tdPaddingBorderedMedium:"12px 16px",tdPaddingBorderedLarge:"16px 24px",tdPaddingSmall:"0 0 8px 0",tdPaddingMedium:"0 0 12px 0",tdPaddingLarge:"0 0 16px 0"};function we(n){const{tableHeaderColor:v,textColor2:h,textColor1:s,cardColor:a,modalColor:u,popoverColor:l,dividerColor:c,borderRadius:i,fontWeightStrong:d,lineHeight:_,fontSizeSmall:r,fontSizeMedium:T,fontSizeLarge:$}=n;return{...Se,lineHeight:_,fontSizeSmall:r,fontSizeMedium:T,fontSizeLarge:$,titleTextColor:s,thColor:O(a,v),thColorModal:O(u,v),thColorPopover:O(l,v),thTextColor:s,thFontWeight:d,tdTextColor:h,tdColor:a,tdColorModal:u,tdColorPopover:l,borderColor:O(a,c),borderColorModal:O(u,c),borderColorPopover:O(l,c),borderRadius:i}}const Ce={common:re,self:we};function Z(n,v="default",h=[]){const{children:s}=n;if(s!==null&&typeof s=="object"&&!Array.isArray(s)){const a=s[v];if(typeof a=="function")return a()}return h}var Pe=B([t("descriptions",{fontSize:"var(--n-font-size)"},[t("descriptions-separator",`
