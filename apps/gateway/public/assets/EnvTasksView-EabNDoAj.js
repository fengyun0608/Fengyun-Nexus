import{d as A,i as t,c as l,b as n,Q as w,R as d,P as x,F as W,y as k,ac as K,ad as Q,ae as Z,af as ee,ag as re,m as _,ah as ie,ai as j,D as M,E as h,H as D,N as te,aj as X,T as oe,U as se,ak as ae,W as Y,u as le,n as ne,o as ce,a as de,e as P,f as B,g as S,r as G,h as F,B as L,j as O,t as I,X as U,k as ue,s as ge,l as pe,v as fe,_ as he}from"./index-BCBwTPlS.js";import{T as ve}from"./Tag-DCw1yOyO.js";import{S as J}from"./Space-DkQWujZ6.js";import{S as ye}from"./Spin-CkMxqfN5.js";const me=["id"],be=["stop-color"],xe=["stop-color"],$e=["viewBox"],ke=["d","stroke-width"],Ce=["d","stroke-width"],Se={success:(t(),k(re)),error:(t(),k(ee)),warning:(t(),k(Z)),info:(t(),k(Q))};var we=A({name:"ProgressCircle",props:{clsPrefix:{type:String,required:!0},status:{type:String,required:!0},strokeWidth:{type:Number,required:!0},fillColor:[String,Object],railColor:String,railStyle:[String,Object],percentage:{type:Number,default:0},offsetDegree:{type:Number,default:0},showIndicator:{type:Boolean,required:!0},indicatorTextColor:String,unit:String,viewBoxWidth:{type:Number,required:!0},gapDegree:{type:Number,required:!0},gapOffsetDegree:{type:Number,default:0}},setup(e,{slots:b}){const v=_(()=>{const a="gradient",{fillColor:o}=e;return typeof o=="object"?`${a}-${ie(JSON.stringify(o))}`:a});function $(a,o,s,f){const{gapDegree:y,viewBoxWidth:u,strokeWidth:m}=e,c=50,g=0,i=c,r=0,z=100,R=50+m/2,C=`M ${R},${R} m ${g},${i}
 ...
 justify-content: center;
 transition: color .3s var(--n-bezier);
 `)]),h("progress-content",{position:"relative"}),h("progress-graph",{position:"relative"},[h("progress-graph-circle",[M("svg",{verticalAlign:"bottom"}),h("progress-graph-circle-fill",`
