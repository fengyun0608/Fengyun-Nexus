...
const zh: Dict = {
  ...
  botName: "机器人名称",
  botWake: "呼唤前缀",
  botWakePh: "例如 nexus，多个用逗号；群里开头带这个就能喊 AI",
  botWakeHint: "群聊要 @ 机器人或用呼唤前缀才会 AI 回复；#帮助 这类指令照常。私聊不用喊。",
  saveBot: "保存机器人设置",
  pluginSource: "源码",
  ...
  templateDir: "模板目录",
  updateTitle: "有新版本",
  updateLead: "确认后拉远程并重启。",
  updateLater: "先不",
  updateNow: "更新",
  updateApplying: "更新中…",
  updateConfirmHint: "本地未提交的改动会被盖掉。",
  environment: "环境",
  envSetup: "环境配置",
...
const en: Dict = {
  ...
  botWakePh: "e.g. nexus, comma-separated; start a group msg with it to call AI",
  botWakeHint: "In groups: @bot or wake prefix to trigger AI. #commands always work. Private chat unrestricted.",
  ...
  updateLead: "Pull remote and restart.",
  updateLater: "Later",
  updateNow: "Update",
  updateApplying: "Updating…",
  updateConfirmHint: "Uncommitted local changes will be overwritten.",
