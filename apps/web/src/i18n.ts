...
const zh: Dict = {
  ...
  channelNotifyGroups: "更新/重启通报群",
  channelNotifyGroupsPh: "群号，逗号分隔",
  channelNotifyGroupsHint: "#更新 与重启成功会同步到这些群。",
...
const en: Dict = {
  ...
  channelNotifyGroups: "Update / restart notify groups",
  channelNotifyGroupsPh: "Group IDs, comma-separated",
  channelNotifyGroupsHint: "#更新 and restart success are also sent to these groups.",
