...
const zh: Dict = {
  ...
  mastersNotSet: "未配置主人",
  configMasters: "配置主人",
  noChannelPluginsHint: "本通道暂无专用插件。主人等通道选项请点「配置主人」。",
  ...
  environment: "环境",
  envSetup: "环境配置",
  envSetupHero: "安装 Go / Python / 浏览器运行时。选择版本与方式后加入待执行任务。",
  envTasks: "环境任务",
  envTasksHero: "查看待执行、运行中与已暂停的安装任务。",
  envVersion: "版本",
  envMode: "安装方式",
  envModeCompile: "编译安装",
  envModeBinary: "二进制安装",
  ...
  channelPluginManageHint: "仅显示本通道 / 指定通道范围的插件；不含全部通道（框架）插件。",
...
const en: Dict = {
  ...
  noChannelPluginsHint: "No channel-scoped plugins here. Use Configure masters for channel options.",
  ...
  envSetup: "Env setup",
  envSetupHero: "Install Go / Python / browser runtimes. Pick version and mode to queue a pending task.",
  envTasks: "Env tasks",
  envTasksHero: "Pending, running, and paused install tasks.",
  envVersion: "Version",
  ...
  envTaskQueued: "Queued as pending task",
  noEnvTasks: "No tasks",
  ...
  channelPluginManageHint:
    "Only channel/specified-scope plugins for this channel — never adapterScope=all.",
