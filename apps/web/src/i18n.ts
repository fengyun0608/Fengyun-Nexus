...
const zh: Dict = {
  ...
  botName: "机器人名称",
  botWake: "呼唤前缀",
  botWakePh: "例如 nexus，多个用逗号",
  botWakeHint: "群聊：@ 机器人或开头带呼唤词才 AI。留空=只能@。私聊/控制台不用喊。#指令照常。",
  saveBot: "保存机器人设置",
  pluginSource: "源码",
...
const en: Dict = {
  ...
  botWakePh: "e.g. nexus, comma-separated",
  botWakeHint: "Groups: @bot or wake prefix for AI. Empty = @ only. Private/console free. #commands always work.",
