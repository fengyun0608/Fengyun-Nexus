...
const zh: Dict = {
  ...
  botName: "机器人名称",
  botWake: "呼唤前缀",
  botWakePh: "例如 nexus，多个用逗号分隔；留空不强制",
  botWakeHint: "配了前缀后可用 nexus帮助 / #nexus帮助，效果同 #帮助。",
  saveBot: "保存机器人设置",
  pluginSource: "源码",
  pluginSourceMissing: "未找到对应插件目录",
  saveFile: "保存文件",
  pickSourceFile: "点左侧文件开始编辑",
  newPlugin: "新建插件",
  newPluginHint: "按目录指引在本机写插件",
  pluginsDir: "插件目录",
  templateDir: "模板目录",
  updateTitle: "发现新版本",
...
const en: Dict = {
  ...
  botName: "Bot name",
  botWake: "Wake prefixes",
  botWakePh: "e.g. nexus, comma-separated; empty = optional",
  botWakeHint: "With a prefix you can say nexus帮助 or #nexus帮助 like #帮助.",
  saveBot: "Save bot settings",
  pluginSource: "Source",
  pluginSourceMissing: "Plugin folder not found",
  saveFile: "Save file",
  pickSourceFile: "Pick a file on the left",
  newPlugin: "New plugin",
  newPluginHint: "Follow the folder guide on this machine",
